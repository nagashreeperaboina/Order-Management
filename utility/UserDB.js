...
var user1=new user('nperaboina','Nagashree','Peraboina','nperaboina@test.edu','216 Barton Creek Drive','AptF', 'Charlotte','North Carolina','26282','America');
var user2=new user( 'speraboina','Svarani',  'Peraboina',  'speraboina@test.edu','216 Barton Creek Drive','Apt F',  'Charlotte',  'North Carolina',  '26282','America');
